var light = {
    ...
    init:function(){
        ...
        light.canvas.addEventListener( 'mousemove', function( e ) {
            light.pointLight.position[ 0 ] = e.clientX;
            light.pointLight.position[ 1 ] = e.clientY;
            console.log("mousemove");
            // light.ctx.save();
            // light.ctx.beginPath();
            // light.ctx.drawImage(star.star_pic, light.pointLight.position[ 0 ], light.pointLight.position[ 1 ], 15 , 15);
            // light.ctx.closePath();
            // light.ctx.restore();
    ...
    draw:function(){
        star.context.putImageData( light.imageData, 0, 0 ); 
    },
    /**
     * 两向量相减
