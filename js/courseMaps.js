var courseMaps = {
    ...
    "singleplayer":[
        ...
        {//2
            "name":"Entitties",
            "briefing":"在这一关，你将开始学习如何建造采油厂来增加我们的经济收入。",
            // 地图细节
            "mapImage":"images/maps/plains-debug.png",
            "startX":4,
            "startY":4,
            ...
            "triggers":[
                /* 时间事件 */
                {
                    ...
                    "time":1000,
                    "action":function(){
                        game.showMessage("操作员","指挥官你好，我是您的操作员爱丽丝。\n在油田上修建采油厂能够增加我们的经济收入。\n请把采油车靠近地图左上角的油田。");
                    },
                },
                // {
                //     "type":"timed",
                ...
                /* 条件事件 */
                {
                    "type":"conditional",
                    "condition":function(){
                        var harvester = game.getItemByName("harvester","buildings");
                        //harvester
                        if(harvester.length>0){
                            for(var i = 0;i<harvester.length;i++){
                                var item = harvester[i];
        ...
        {//3
            ...
            //预加载的单位类型
            "requirements":{
                "buildings":["base","harvester","ground-turret"],
                "vehicles":["scv","transport","harvester","scout-tank","heavy-tank"],
                "aircraft":["chopper","wraith"],
                "terrain":["oilfield","bigrocks","smallrocks"]
            },
            ...
            items:[
                ...
                {"type":"buildings","name":"harvester",x:3,y:5,"team":"blue","direction":3,"uid":-1},
                {"type":"vehicles","name":"scout-tank","x":57,"y":30,"team":"green","orders":{"type":"stand"},"uid":-2},
                //{"type":"terrain","name":"oilfield",x:3,y:5,"action":"hint"},
                {"type":"terrain","name":"bigrocks",x:19,y:6,},
                {"type":"terrain","name":"smallrocks",x:8,y:3,},
            ...
            "triggers":[
                /* 时间事件 */
                {
                    ...
                    "time":1000,
                    "action":function(){
                        game.showMessage("操作员","指挥官你好。\n我们需要建造防御工事来抵御敌人攻击，请选择主基地建造scv。");
                    },
                },
                // {
                //     "type":"timed",
                ...
                /* 条件事件 */
                {
                    "type":"conditional",
                    "condition":function(){
                        var scv = game.getItemByName("scv","vehicles");
                        
                        return scv.length>0;
                    },
                    "action":function(){
                        game.showMessage("操作员","scv能建造炮塔来抵御敌人的进攻，请选择scv并在主基地右方建造一个炮塔");
                    },
                },
                {
                    "type":"conditional",
                    "condition":function(){
                        var groundTurret = game.getItemByName("ground-turret","buildings");
                        return groundTurret.length>0;
                    },
                    "action":function(){
                        game.showMessage("操作员","敌人开始进攻了");
                        var tank = game.getItemByUid(-2);
                        tank.orders = {"type":"hunt"};
                    },
                },
                {
                    "type":"conditional",
        ...
        {//4
            "name":"Entitties",
            "briefing":"在这一关，你将开始学习如何建造星港来生成军事单位。",
            // 地图细节
            "mapImage":"images/maps/plains-debug.png",
            "startX":4,
            "startY":4,
            ...
            //预加载的单位类型
            "requirements":{
                "buildings":["base","harvester","ground-turret","starport"],
                "vehicles":["scv","transport","harvester","scout-tank","heavy-tank"],
                "aircraft":["chopper","wraith"],
                "terrain":["oilfield","bigrocks","smallrocks"]
            },
            ...
            items:[
                ...
                {"type":"buildings","name":"harvester",x:3,y:5,"team":"blue","direction":3,"action":"deploy"},
                {"type":"vehicles","name":"scout-tank","x":57,"y":30,"team":"green","orders":{"type":"stand"},"uid":-2},
                //{"type":"terrain","name":"oilfield",x:3,y:5,"action":"hint"},
                {"type":"terrain","name":"bigrocks",x:19,y:6,},
                {"type":"terrain","name":"smallrocks",x:8,y:3,},
            ...
            "triggers":[
                ...
                /* 条件事件 */
                {
                    ...
                    "action":function(){
                        game.showMessage("操作员","scv能建造造星港来生产军事单位，请选择scv并在主基地右方建造一个星港");
                    },
                },
                {
                    "type":"conditional",
                    "condition":function(){
                        var starport = game.getItemByName("starport","buildings");
                        return starport.length>0;
                    },
                    "action":function(){
                        game.showMessage("操作员","星港已经建造完成，请选择星港并建造一辆轻型坦克和一架直升飞机。");
                    },
                },
                {
                    "type":"conditional",
                    "condition":function(){
                        var tank = game.getItemByName("scout-tank","vehicles");
                        var chopper = game.getItemByName("chopper","aircraft");
                        var tmp = false;
                        for(var i = 0;i<tank.length;i++){
                            if(tank[i].team==game.team){
                                tmp = true;
                            }
                        }
                        return chopper.length>0 && tank.length>0 && tmp;
                    },
                    "action":function(){
                        game.showMessage("操作员","检测到地图右边有敌军，请求消灭敌军单位。");
                    },
                },
                {
                    "type":"conditional",
